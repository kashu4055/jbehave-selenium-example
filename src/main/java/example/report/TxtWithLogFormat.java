...
public class TxtWithLogFormat extends Format {

    private final JBehaveAppender appender;

    public TxtWithLogFormat(JBehaveAppender pAppender) {
        super("TXT");
    ...
    public StoryReporter createStoryReporter(FilePrintStreamFactory factory, StoryReporterBuilder builder) {
        factory.useConfiguration(builder.fileConfiguration("txt"));
        TxtOutputWithLog storyReporter = new TxtOutputWithLog(factory.createPrintStream());
